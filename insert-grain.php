...
if (mysqli_query($db2, $sql2)) { }
 //LOG END
    $sql = "INSERT INTO grain (username, strain, location, label, source) VALUES ('$currentuser', '$strain', '$location', '$label', '$source')";
    if (mysqli_query($db2, $sql)) {
        echo "Grain bag added. Sit back and let that shit colonise! </br><a href='grain.php'>Go back</a>";
     } else {
...
<meta http-equiv="refresh" content="3; url='grain.php'" />
</head></html>
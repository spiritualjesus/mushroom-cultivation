...
class MySQLtabledit {
	...
	*/
    ...
    $bags = "SELECT COUNT(*) AS bags FROM grain $where_search"; 
    $contam = "SELECT SUM(contam) AS contam FROM grain $where_search";
    $active = "SELECT SUM(active) AS active FROM grain $where_search"; 
    $result = mysqli_query($db2, $bags);
    $result2 = mysqli_query($db2, $contam); 
    $result3 = mysqli_query($db2, $active);
    ...
    { 
        ...
        $row3 = mysqli_fetch_assoc($result3);
           ...
           if ($row) 
              { 
                 printf("<div align=\"left\" style=\"padding-left: 2px;\">Total number of grain bags : " . $row['bags']);
                 printf("<div align=\"left\">Total number of contaminated grain bags : " . $row2['contam']); 
                 printf("<div align=\"left\">Total number of active grain bags : " . $row3['active']); 
              }  

...
class MySQLtabledit {
	...
	*/
    ...
    { 
	 ...
	 $tubs = "SELECT SUM(tubs) AS tubs FROM archive_spawn $where_search"; 
	 $contam = "SELECT SUM(contam) AS contam FROM archive_spawn $where_search"; 
	 ...
	 $result2 = mysqli_query($db2, $contam); 
		...
		{ 
		  ...
		  $total = $row['tubs'] - $row2['contam'];
		     ...
		     if ($row) 
		        { 
		           printf("<div align=\"left\" style=\"padding-left: 4px; padding-top: 2px;\">Total number of archived tubs : " . $row['tubs']);
		           printf("<div align=\"left\" style=\"padding-top: 2px;\">Total number of contaminated tubs : " . $row2['contam']); 
		           printf("<div align=\"left\" style=\"padding-top: 2px;\">Total number of tubs spawned successfully: " . $total); 
		        } 

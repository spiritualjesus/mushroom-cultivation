...
class MySQLtabledit {
	...
	*/
    ...
    $query = "SELECT id FROM spores $where_search";  
    ...
    { 
        $row = mysqli_num_rows($result); 
           ...
           if ($row) 
              { 
                 printf("<div align=\"left\" style=\"padding-left: 4px;\">Total number of spores in database : " . $row); 
              } 

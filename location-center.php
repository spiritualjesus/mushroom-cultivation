...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    <title><?php echo $company; ?> - Location Center</title>
...
?>
	...
	<div align="left"><a href="welcome.php" class="btn btn-primary">Main Portal</a></br></br>
	<div class="w3-dropdown-hover">
	<a href="admin.php" class="btn btn-info">Admin Home</a>
			<div class="w3-dropdown-content">
				<a href="location-center.php" class="w3-bar-item btn btn-default" title="" role="button">Location Center</a>
			</div></div></div>
	...
	</div><center><h3>Location Center</h3></center>
	 <p> <div class="row">		
	 <div align="left" style="padding-left:30px">	
<? 
include ("tables/admin/location.php"); ?> </div></div>

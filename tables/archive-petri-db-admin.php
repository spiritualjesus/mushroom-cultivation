...
require_once("mte/archive-mte-petri-admin.php");
...
# Always add the primary key (`ID)`: 
	...
	$tabledit->fields_in_list_view = array('id','date','username','strain','location','label','description','dishes','contam');
...
#$tabledit->fields_to_edit = array('date','strain','location','label','description','dishes','contam');

...
require_once("mte/admin/users.php");
...
# Always add the primary key (`ID)`: 
	...
	$tabledit->fields_in_list_view = array('id','username','canimport','admin','created_by','created_at');
...
$tabledit->fields_to_edit = array('username','canimport');

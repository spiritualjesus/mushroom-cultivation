...
require_once("mte/mte-spawn-admin.php");
...
# Always add the primary key (`ID)`: 
	...
	$tabledit->fields_in_list_view = array('id','date','username','strain','location','label','tubs','contam','fruit');
...
$tabledit->fields_to_edit = array('date','strain','location','label','tubs','contam','fruit');

...
require_once("mte/mte-grain-admin.php");
...
# Always add the primary key (`ID)`: 
	...
	$tabledit->fields_in_list_view = array('id','date','username','strain','location','label','source','contam','active');
...
$tabledit->fields_to_edit = array('date','strain','location','label','source','bags','contam','active');

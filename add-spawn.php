...
<h3 align="left">Add a spawn</h3>
        <form action="insert-spawn.php" method="post">
        ...
        <input id="new-species" name="new-species" title="new-species" style="width: 250px;"></input>
            ...
            <div class="form-group">
                <label>Tubs (quantity)</label>
                <input type="text" required="required" name="tubs" value="2" class="form-control" style="width: 50px;" onfocus="this.value=''">
            </div>
            <div class="form-group">

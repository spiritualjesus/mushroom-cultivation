...
<h3 align="left">Add a Petri dish</h3>
        <form action="insert-petri.php" method="post">
        ...
        <input id="new-species" name="new-species" title="new-species" style="width: 250px;"></input>
            ...
            <div class="form-group">
                ...
                <input type="text" required="required" name="description" size="50" value="Cluster clone" class="form-control" style="width: 300px;" onfocus="this.value=''">
            </div>
             <div class="form-group">
                <label>Dishes (Quantity)</label>
                <input type="text" required="required" name="dishes" value="1" class="form-control" style="width: 50px;" onfocus="this.value=''">
            </div>
            <div class="form-group">
